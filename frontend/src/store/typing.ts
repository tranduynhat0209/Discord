...
const slice = createSlice({
  ...
  reducers: {
    userTyped: (typing, { payload }: Action<{ channelId: string, userId: string }>) => {      
      typing.push(payload);
    },
    userStoppedTyping: (typing, { payload }: Action<{ channelId: string, userId: string }>) => {
...
export const startTyping = (channelId: string) => (dispatch, getState: () => AppState) => {
