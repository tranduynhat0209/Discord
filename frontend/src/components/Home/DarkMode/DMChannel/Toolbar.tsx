...
export default function Toolbar() {
    const { showOptions, searchItemRef, handleSearchItemClick } =
        useSearchOptions();

    return (
        <div className="toolbar">
            <div aria-label="Chu de" className="toolbar-item">
                <svg
                    x="0"
                    y="0"
                    aria-hidden="true"
            ...
            <div aria-label="abc" className="toolbar-item">
                <svg
                    x="0"
                    y="0"
                    aria-hidden="true"
            ...
            <div
                aria-label="Chu de"
                className="toolbar-item search-bar"
                ref={searchItemRef}
